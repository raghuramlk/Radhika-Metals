...
/**
 * Servlet implementation class dcdel
 */
@WebServlet("/dcdel")
public class dcdel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(cid!=null||cid!="")
		{		
		String custmast="delete from dc_master where dc_id='"+cid+"'";
		...
		if(status>=1)
		{
			...
			errormsg="DC Record Deleted Successfully.....";
		}
		else{
